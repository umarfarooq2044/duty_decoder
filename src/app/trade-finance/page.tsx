        ...
        },
        {
            ...
            content: `<div style="display:flex;flex-direction:column;gap:1.5rem;margin-top:0.5rem;">
                ...
                <div style="border-left:4px solid var(--accent);padding-left:1.5rem;">
                    ...
                    <p style="color:var(--muted-foreground);font-size:0.95rem;">Protects exporters against buyer default (commercial risk) and country risk (war, sanctions, currency inconvertibility). Providers include <a href="https://www.coface.com/" target="_blank" rel='noopener'>Coface</a>, <a href="https://www.eulerhermes.com/" target="_blank" rel='noopener'>Allianz Trade</a>, and <a href="https://www.atradius.com/" target="_blank" rel='noopener'>Atradius</a>. Typically covers 80–95% of invoice value. Premiums: 0.1–1% of insured turnover.</p>
                </div>
                <div style="border-left:4px solid var(--accent);padding-left:1.5rem;">
