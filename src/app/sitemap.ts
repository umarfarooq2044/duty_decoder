...
// Static sitemap generated at build time — no force-dynamic
// Next.js will call this function once during `next build` and output sitemap.xml
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    // Fetched at build time — all existing calculation result pages
