...
export default function ExportDocumentsPage() {
    ...
    const sections = [
        ...
        },
        {
            ...
            <p><strong>Determining if you need a license:</strong> Classify your product → Check the CCL/USML → Screen end-user against <a href="https://www.bis.doc.gov/index.php/policy-guidance/lists-of-parties-of-concern" target="_blank" rel='noopener'>Denied Persons/Entity Lists</a> → Check destination country against <a href="https://www.bis.doc.gov/index.php/regulations/commerce-country-chart" target="_blank" rel='noopener'>Commerce Country Chart</a> → Apply for license if required.</p>`
        },
        {
        ...
        },
        {
            ...
            content: `<ol style="padding-left:1.5rem;">
                ...
                <li style="margin-bottom:1rem;"><strong>Screen the transaction:</strong> Check the buyer, end-user, and destination against restricted party lists (SDN, Entity List, Denied Persons). Use <a href="https://www.bis.doc.gov/index.php/policy-guidance/lists-of-parties-of-concern/consolidated-list" target="_blank" rel='noopener'>BIS Consolidated Screening List</a>.</li>
        ...
        <main style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 clamp(1rem, 4vw, 1.5rem)" }} role="main">
            ...
            <div className="content-sidebar-grid">
                ...
                <aside aria-label="Quick links" style={{ position: "sticky", top: "100px", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                    ...
                    <nav aria-label="Official" style={{ background: "rgba(34,197,94,0.04)", border: "1px solid rgba(34,197,94,0.15)", borderRadius: "12px", padding: "1.25rem" }}><h3 style={{ fontSize: "0.8rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em", color: "var(--muted-foreground)", marginBottom: "0.75rem" }}>Official Sources</h3><ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.5rem" }}><li><a href="https://www.bis.doc.gov/" target="_blank" rel='noopener' style={{ fontSize: "0.85rem", color: "var(--accent)", textDecoration: "none" }}>BIS Export Controls ↗</a></li><li><a href="https://aesdirect.census.gov/" target="_blank" rel='noopener' style={{ fontSize: "0.85rem", color: "var(--accent)", textDecoration: "none" }}>AESDirect Filing ↗</a></li><li><a href="https://www.trade.gov/export-solutions" target="_blank" rel='noopener' style={{ fontSize: "0.85rem", color: "var(--accent)", textDecoration: "none" }}>Trade.gov Export Solutions ↗</a></li></ul></nav>
