...
export default function ImportFromChinaPage() {
    ...
    const sections = [
        ...
        },
        {
            ...
            content: `<p>Since 2018, the United States has imposed additional tariffs on Chinese goods under <a href="https://ustr.gov/issue-areas/enforcement/section-301-investigations" target="_blank" rel='noopener'>Section 301 of the Trade Act of 1974</a>. These tariffs are <strong>in addition to</strong> regular MFN duty rates and significantly increase the cost of importing from China.</p>
            ...
            <p style="margin-top:1rem;">Check if your product is affected using the <a href="https://hts.usitc.gov/" target="_blank" rel='noopener'>USITC HTS database</a> — Section 301 tariffs are marked in the "Special" column with "9903.88" subheadings.</p>`
        },
        {
            ...
            <ul style="padding-left:1.5rem;">
                <li style="margin-bottom:0.75rem;">✅ Request business license (营业执照) and verify on China's <a href="https://www.gsxt.gov.cn/" target="_blank" rel='noopener'>National Enterprise Credit Information System</a></li>
                ...
                <li style="margin-bottom:0.75rem;">✅ Check export history on <a href="https://www.importgenius.com/" target="_blank" rel='noopener'>ImportGenius</a> or Panjiva</li>
        ...
        },
        {
            ...
            <p style="margin-top:1.5rem;"><strong>Inspection providers:</strong> <a href="https://www.sgs.com/" target="_blank" rel='noopener'>SGS</a>, <a href="https://www.qima.com/" target="_blank" rel='noopener'>QIMA (AsiaInspection)</a>, <a href="https://www.bureauveritas.com/" target="_blank" rel='noopener'>Bureau Veritas</a>, <a href="https://www.intertek.com/" target="_blank" rel='noopener'>Intertek</a>, and V-Trust. Prices range from $250–$500 per man-day depending on location and complexity.</p>`
        },
        {
        ...
        <main style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 clamp(1rem, 4vw, 1.5rem)" }} role="main">
            ...
            <div className="content-sidebar-grid">
                ...
                <aside aria-label="Quick links" style={{ position: "sticky", top: "100px", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                    ...
                    <nav aria-label="Official" style={{ background: "rgba(34,197,94,0.04)", border: "1px solid rgba(34,197,94,0.15)", borderRadius: "12px", padding: "1.25rem" }}><h3 style={{ fontSize: "0.8rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em", color: "var(--muted-foreground)", marginBottom: "0.75rem" }}>Official Sources</h3><ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.5rem" }}><li><a href="https://ustr.gov/issue-areas/enforcement/section-301-investigations" target="_blank" rel='noopener' style={{ fontSize: "0.85rem", color: "var(--accent)", textDecoration: "none" }}>USTR Section 301 Info ↗</a></li><li><a href="https://hts.usitc.gov/" target="_blank" rel='noopener' style={{ fontSize: "0.85rem", color: "var(--accent)", textDecoration: "none" }}>USITC HTS Lookup ↗</a></li><li><a href="https://www.cbp.gov/trade" target="_blank" rel='noopener' style={{ fontSize: "0.85rem", color: "var(--accent)", textDecoration: "none" }}>US CBP Trade ↗</a></li></ul></nav>
