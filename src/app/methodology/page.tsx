        ...
        <main className="methodology-page" style={{ padding: "clamp(2rem, 5vw, 4rem) 1rem", maxWidth: "1000px", margin: "0 auto" }}>
            ...
            <section className="glass-panel" style={sectionStyle}>
                ...
                <div style={bodyStyle}>
                    ...
                    <ul style={listStyle}>
                        <li>
                            <strong>United States — <a href="https://hts.usitc.gov/" target="_blank" rel='noopener'>USITC HTS</a>:</strong> Harmonized Tariff Schedule maintained by the U.S. International Trade Commission, including Section 201, Section 301 tariffs, and AD/CVD orders. We track <a href="https://www.federalregister.gov/" target="_blank" rel="nofollow">Federal Register</a> updates within 48 hours of publication.
                        </li>
                        <li>
                            <strong>European Union — <a href="https://ec.europa.eu/taxation_customs/dds2/taric/taric_consultation.jsp" target="_blank" rel='noopener'>EU TARIC</a> / Combined Nomenclature:</strong> Full EU customs tariff including preferential duty rates, anti-dumping duties, and country-specific suspensions. Updated in alignment with <a href="https://eur-lex.europa.eu/" target="_blank" rel='noopener'>Official Journal of the European Union</a> publications.
                        </li>
                        <li>
                            <strong>United Kingdom — <a href="https://www.trade-tariff.service.gov.uk/" target="_blank" rel='noopener'>HMRC UK Global Tariff</a>:</strong> Post-Brexit UK tariff schedule maintained by His Majesty&apos;s Revenue and Customs. Includes UKGT-specific preference rates under CPTPP and UK-Japan CEPA.
                        </li>
                        <li>
                            <strong>Pakistan — <a href="https://www.fbr.gov.pk/customs-tariff/131253" target="_blank" rel='noopener'>FBR PCT / SROs</a>:</strong> Pakistan Customs Tariff from the Federal Board of Revenue, incorporating Regulatory Duties (RD), Additional Customs Duty (ACD), and Statutory Regulatory Orders that change frequently.
                        </li>
                        <li>
                            <strong>50+ Additional Jurisdictions:</strong> Including <a href="https://www.cbsa-asfc.gc.ca/trade-commerce/tariff-tarif/" target="_blank" rel='noopener'>Canada (CBSA)</a>, <a href="https://www.customs.go.jp/english/tariff/" target="_blank" rel='noopener'>Japan (MOF)</a>, <a href="https://www.cbic.gov.in/entities/customs-tariff" target="_blank" rel='noopener'>India (CBIC)</a>, <a href="https://www.abf.gov.au/importing-exporting-and-manufacturing/tariff-classification" target="_blank" rel='noopener'>Australia (ABF)</a>, UAE (FCA), Singapore (SC), <a href="https://www.customs.go.kr/english/" target="_blank" rel='noopener'>South Korea (KCS)</a>, Turkey (GTB), Mexico (SAT), Brazil (RFB), and others. Each country&apos;s rates are sourced from its officially published tariff schedule.
                        </li>
                    </ul>
                </div>
            </section>
            ...
            <section className="glass-panel" style={sectionStyle}>
                ...
                <div style={bodyStyle}>
                    <p style={{ marginBottom: "1.25rem" }}>
                        Customs misclassification is the single largest source of import penalties globally. A miscoded HS heading can mean a 15% duty swing or a shipment held at port for weeks. To mitigate this, we built a <strong>multi-layer AI classification pipeline</strong> that mirrors the decision-making process of a licensed customs broker — but in seconds. Our classification methodology follows the <a href="https://www.wcoomd.org/en/topics/nomenclature/overview/what-is-the-harmonized-system.aspx" target="_blank" rel='noopener'>WCO Harmonized System</a> conventions used by over 200 countries.
                    </p>
            ...
            <section className="glass-panel" style={sectionStyle}>
                ...
                <div style={bodyStyle}>
                    <ul style={listStyle}>
                        <li><strong>Preferential Rates:</strong> Our default duty rates reflect MFN (Most Favoured Nation) rates. Preferential rates under specific FTAs (e.g., <a href="https://ustr.gov/trade-agreements/free-trade-agreements/united-states-mexico-canada-agreement" target="_blank" rel='noopener'>USMCA</a>, <a href="https://www.dfat.gov.au/trade/agreements/in-force/cptpp" target="_blank" rel='noopener'>CPTPP</a>, EU-Korea FTA) are not automatically applied because they require proof of origin documentation that varies by agreement. We note when FTA savings may be available.</li>
